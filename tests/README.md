...
| [integration/zsh/zsh-plugins.bats](integration/zsh/zsh-plugins.bats)                               | Completion discovery and permission auditing, plugin loading order, prefix selection, missing dependencies, and arrow bindings.     |
